...
.rec-menu-btn{background:none;border:none;cursor:pointer;color:#9a9088;font-size:18px;padding:4px 6px;border-radius:8px;line-height:1;letter-spacing:-3px;transition:background .12s;min-width:40px;min-height:40px;display:flex;align-items:center;justify-content:center}
