...
.rec-menu-btn{background:none;border:none;cursor:pointer;color:var(--t1);font-size:36px;padding:8px 10px;border-radius:16px;line-height:1;transition:background .12s;min-width:44px;min-height:44px;display:flex;align-items:center;justify-content:center}
