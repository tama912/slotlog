...
:root{
  ...
  --sh-hero:0 2px 8px rgba(249,115,22,0.12),0 1px 3px rgba(0,0,0,0.05);
}
...
/* Hero copy under KPI */
.hero-copy{font-size:11px;font-weight:500;color:var(--t3);margin-top:6px;opacity:0.85}
...
.rec-menu-btn{background:none;border:none;cursor:pointer;color:rgba(24,18,14,0.5);font-size:72px;padding:6px 8px;border-radius:32px;line-height:1;transition:background .12s;min-width:44px;min-height:44px;display:flex;align-items:center;justify-content:center}
